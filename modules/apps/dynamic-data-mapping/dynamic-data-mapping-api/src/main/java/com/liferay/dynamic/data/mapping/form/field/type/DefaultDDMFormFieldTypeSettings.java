...
public interface DefaultDDMFormFieldTypeSettings
	...
	@DDMFormField(
		...
		properties = {
			...
			"tooltip=%enter-a-descriptive-field-label-that-guides-users-to-enter-the-information-you-want", "visualProperty=true"
		},
		type = "text"
	)
	...
	@DDMFormField(
		...
		properties = {
			...
			"tooltip=%enter-a-default-value-that-is-submitted-if-no-other-value-is-entered", "visualProperty=true"
		},
		type = "text"
	)
	...
	@DDMFormField(
		label = "%help-text",
		properties = {"tooltip=%add-a-comment-to-help-users-understand-the-field-label", "visualProperty=true"} ,
		type = "text"
	)
